...
sbutton.pack()
restart.pack()
player_pic = tkinter.PhotoImage(file="player.png.png")
exit_pic = tkinter.PhotoImage(file="exit.png.png")
fire_pic = tkinter.PhotoImage(file="fire.png.png")
enemy_pic = tkinter.PhotoImage(file="enemy.png.png")
prepare_and_start()
master.mainloop()
